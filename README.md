...
| &nbsp;&nbsp;→ **RND Display** | Gear (R/N/D), inverted in reverse | `#gear-display`, `#reverse-indicator` |
...
| **Button Control** | Short/long press: mode, reset, contrast, zero | `#button-input`, `#ui-control` |
